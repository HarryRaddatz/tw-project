	...
	<tr>
		<td>
			...
			<div id="more_1" style="display: none">
				<ul>
					<li> It is forbidden to share passwords with players in the same world. </li>
			...
			while they are away. The restrictions discussed in <b> §2 </b> are enforced in the event of vacation substitution and are valid for all accounts played by the substitute concerned, ie interactions between accounts managed by the same substitute (including the account). substitute) are prohibited. Sending support to them is also prohibited. Substitutes who clearly perform destructive actions against the vacation account will be punished. <br /> <br />
