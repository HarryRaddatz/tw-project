...
" /></td></tr>
					<tr><td width="100">Abbreviation:</td><td><input type="text" name="tag" maxlength="6" value="<?php echo $this->_tpl_vars['ally']['short']; ?>
" /><br /><b>maximum 6 caracteres</b></td></tr>
...
" /></td></tr>
					<tr><td width="100">IRC:</td><td><input type="text" name="irc-channel" maxlength="128" size="25"  value="<?php echo $this->_tpl_vars['ally']['irc']; ?>
" /></td></tr>
					<tr><th colspan="2"><div align="right"><input type="submit" value="SUBMIT" class="button" /></div></th></tr>
				</table>
			</form>
			<table class="vis" width="100%" style="border:1px solid #804000;">
				<tr><th>Disband tribe</th></tr>
				<tr><td><a href="javascript:ask('Do you really want to disband your tribe??', 'game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
&amp;screen=ally&amp;mode=properties&amp;action=close&amp;h=<?php echo $this->_tpl_vars['hkey']; ?>
')">&raquo; disband</a></td></tr>
			</table>
		<?php endif; ?>
		</td>
		<td valign="top" width="50%">
...
" method="post" name="edit_profile">
				<table class="vis" width="100%" style="border:1px solid #804000; border-bottom:none;">
					<tr><th colspan="2">Tribe description <span style="float:right;"><a id="edit_link" href="javascript:bbEdit()" style="display:none"><span class="button">EDITAR</span></a><a id="edit_link_close" href="javascript:bbEdit_close()" style="display:none"><span class="button">CANCELAR</span></a></span></th></tr>
					...
					<tr id="submit_row">
						...
						<th width="50%"><div align="center">
							<input type="submit" name="preview" value="VIEW" class="button" />
							<input type="submit" name="edit" value="SUBMIT" class="button green" />
						</div></th>
					</tr>
				</table>
			</form>
