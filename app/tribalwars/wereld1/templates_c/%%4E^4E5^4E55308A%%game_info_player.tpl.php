...
">&raquo; Send Message</a></td></tr>
			<?php if ($this->_tpl_vars['can_invite']): ?>
				<tr><td colspan="2"><a href="javascript:ask('Do you want to invite the player<?php echo $this->_tpl_vars['info_user']['username']; ?>
...
&screen=settings&mode=profile"><span class="button">Edit</span></a><?php endif; ?></span></th></tr>
