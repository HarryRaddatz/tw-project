	...
	<tr>
		<td valign="top" width="40%">
			<table class="vis" width="100%" style="border:1px solid #804000;">
				...
				<tr><td width="80">Coordinates:</td><td><?php echo $this->_tpl_vars['info_village']['x']; ?>
|<?php echo $this->_tpl_vars['info_village']['y']; ?>
				...
				<?php else: ?>
				<tr><td>Player:</td><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
"><?php echo $this->_tpl_vars['info_user']['username']; ?>
				...
				<tr><td>Tribe:</td><td><a href="game.php?village=<?php echo $this->_tpl_vars['village']['id']; ?>
...
&amp;screen=overview">&raquo; View	&ccedil;&atilde;o geral da aldeia</a></th></tr>
				<?php endif; ?>
			</table>
		</td>
