...
<div align="right">
<a href="javascript:window.close();">schlie�en</a>
</div>
<h3>Ziele</h3>
<table class="vis">
<tbody>
<tr>
<td class="selected">
<a href="javascript:popup_scroll('targets.php?village={$village}', 520, 520);" target="_self">Eigene D�rfer</a>
</td>
</tr>
</tbody>
